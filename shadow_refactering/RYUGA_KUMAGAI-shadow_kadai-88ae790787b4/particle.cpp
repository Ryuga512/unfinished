...
//					{
//						g_aParticle[nCntParticle].material.Diffuse.r = 0.8f - (float)(80 - g_aParticle[nCntParticle].nLife) / 80 * 0.8f;
//						g_aParticle[nCntParticle].material.Diffuse.g = 0.1f - (float)(80 - g_aParticle[nCntParticle].nLife) / 80 * 0.1f;
//						g_aParticle[nCntParticle].material.Diffuse.b = 0.2f - (float)(80 - g_aParticle[nCntParticle].nLife) / 80 * 0.2f;
//					}
//
...
//			g_mtxWorldParticle._12 = mtxView._12;
//			g_mtxWorldParticle._13 = mtxView._13;
//			g_mtxWorldParticle._21 = mtxView._21;
//			g_mtxWorldParticle._22 = mtxView._22;
//			g_mtxWorldParticle._23 = mtxView._23;
//			g_mtxWorldParticle._31 = mtxView._31;
//			g_mtxWorldParticle._32 = mtxView._32;
...
//#ifdef DISP_SHADOW
//			// 影の設定
//			g_aParticle[nCntParticle].nIdxShadow = CreateShadow(D3DXVECTOR3(pos.x, 0.1f, pos.z), 0.8f, 0.8f);		// 影の設定
//			if(g_aParticle[nCntParticle].nIdxShadow != -1)
//			{
