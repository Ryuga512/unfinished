...
// マクロ定義
//*********************************************************
#define VIEW_NEAR_Z (40.0f)
#define VIEW_FAR_Z  (300.0f)
...
//	hr = D3DX11CompileFromFile( "shader.hlsl", NULL, NULL, "PixelShaderPolygon", "ps_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, NULL, &pPSBlob, &pErrorBlob, NULL );
    ...
    hBufferDesc.ByteWidth = sizeof(cam->at);
	...
	//ライト初期化
	g_Light.Direction = D3DXVECTOR4(5.0f, 10.0f, 0.0f, 0.0f);
    g_Light.Position = D3DXVECTOR4(5.0f, 10.0f, 0.0f, 1.0f);
    g_Light.Attenuation = D3DXVECTOR4(0.0f, 0.0f, 0.2f, 0.0f);
...
void UpdateRenderer(float x, float y, float z)
{
    D3DXMATRIX Rot;
    D3DXMatrixIdentity(&Rot);
    D3DXMatrixRotationX(&Rot, x * 0.7);
    g_Light.Position = D3DXVECTOR4(x, y, z, 1.0f);
    g_Light.Direction = D3DXVECTOR4(0, 1, 0, 0);
    D3DXVec4Transform(&g_Light.Direction, &D3DXVECTOR4(0, 1, 0, 0), &Rot);
    D3DXVec4Normalize(&g_Light.Direction, &g_Light.Direction);
    SetLight(g_Light);
    return;
}
